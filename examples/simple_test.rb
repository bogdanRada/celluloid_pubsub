...
CelluloidPubsub.configure do |config|
  config.spy = true
end
...
CelluloidPubsub::BaseActor.setup_actor_supervision(CelluloidPubsub::Server::HTTP, actor_name: :web_server, args: {quiet: debug_enabled, adapter: nil,log_file_path: log_file_path })
